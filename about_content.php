                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-process text-center mb-30">
                            ...
                            <div class="process-cap">
                                ...
                                <p>Fill the Keyword in the search box and location and search for jobs</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <div class="single-process text-center mb-30">
                            ...
                            <div class="process-cap">
                                ...
                                <p>Fill the details about yourself in the form and click on apply </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <div class="single-process text-center mb-30">
                            ...
                            <div class="process-cap">
                                ...
                                <p>Soon The Company HR will Contact You for The JOB</p>
                            </div>
                        </div>
                    </div>
                </div>
